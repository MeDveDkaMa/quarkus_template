-- INSERT INTO gift(id,name) VALUES (1,'Test1');
-- INSERT INTO gift(id,name) VALUES (2,'bear');
-- INSERT INTO gift(id,name) VALUES (3,'fly');
-- INSERT INTO gift(id,name) VALUES (4,'mouse');

-- INSERT INTO customers(id, age,fistname,lastname,email, adress ) VALUES (1,15,'Alexei','Morozov','morozovE','morozov9May');
-- INSERT INTO customers(id, age,fistname,lastname,email,adress ) VALUES (2,17,'Maria','Nikolaeva','NikolaevaE','maria9May');
...
-- INSERT  INTO dish(id, composition, name, price) VALUES (1,'Свекла, капуста','Борщ',255);